...
#ifdef SGX_TEST
#define TEST_CONFIG_DEFAULT_CACHE_SIZE_MB        1
#else
...
#define TEST_CONFIG_DEFAULT_FANOUT                6
#define TEST_CONFIG_DEFAULT_MAX_BRANCHES_PER_NODE 12
...
#ifdef SGX_TEST
      .cache_capacity           = MiB_TO_B(TEST_CONFIG_DEFAULT_CACHE_SIZE_MB),
#else
...
config_usage()
{
   ...
   platform_error_log("\t--cache-capacity-mib (%d)\n",
                      TEST_CONFIG_DEFAULT_CACHE_SIZE_MB);
#else
