...
static inline platform_status
allocator_get_super_addr(allocator *al, allocator_root_id spl_id, page_reference *ref)
{
   return al->ops->get_super_addr(al, spl_id, ref);
}
...
allocator_alloc_super_addr(allocator        *al,
                           ...
                           page_reference   *ref)
{
   return al->ops->alloc_super_addr(al, spl_id, ref);
}
